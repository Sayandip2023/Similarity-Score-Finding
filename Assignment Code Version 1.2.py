...
# Initialize a dictionary to store similarity scores for each paper's reference list
similarity_scores = {}
    ...
    if paper_id in citation_network:
        ...
        for reference_id in citation_network[paper_id]:
            if reference_id in abstracts:
                ...
                similarity_scores[paper_id][reference_id] = similarity_score
...
# Save similarity_scores dictionary to a file
output_file = 'similarity_scores.json'
with open(output_file, 'w') as json_file:
    json.dump(similarity_scores, json_file)

print("Similarity scores saved to:", output_file)
